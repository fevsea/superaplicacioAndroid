...
public class Help extends BackToolBar {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ExpandableListView expandable = (ExpandableListView) findViewById(R.id.expandableList);
    ...
    private void addNewElement(String name, String value) {
        ...
        Map<String, String> childrenitem1 = new HashMap<>();
